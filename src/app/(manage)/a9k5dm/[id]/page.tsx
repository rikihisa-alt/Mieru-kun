...
export default function CustomerDetailPage() {
  ...
  const initial: CustomerData = found
    ? {
        name: found.name, nickname: found.nickname, phone: found.phone,
        email: found.email ?? "", rank: found.rank, notes: found.notes ?? "",
        totalVisits: found.totalVisits, totalSpent: found.totalSpent,
        chipBalance: found.chipBalance, pointBalance: found.pointBalance,
      }
    : DEFAULT_CUSTOMER;
