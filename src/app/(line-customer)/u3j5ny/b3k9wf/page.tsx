      ...
      <div className="ln-stack">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
          ...
          <div className="ln-card ln-card-compact">
            ...
            <div className="ln-num" style={{ fontSize: 20, fontWeight: 700, color: "var(--ln-rank-gold)" }}>
          ...
          <div className="ln-card ln-card-compact" style={{ gridColumn: "span 2" }}>
            ...
            <div className="ln-num" style={{ fontSize: 24, fontWeight: 700, color: "var(--ln-rank-vip)" }}>
